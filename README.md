...
<br>This is the most complete and up-to-date description of the symbolic execution method implemented by the `asm-symbolic-execution` tool. Compared to the original 2024 paper, various additional ASM constructs are supported: variables, `let` terms and rules, quantifiers (over finite sets), `forall` rules and call rules. Furthermore, it is shown how symbolic execution can be used to verify invariant properties on finite prefixes of sequential ASM runs ("bounded verification").
...
<br>The extended version additionally includes a summary of ASM syntax and semantics, more detailed explainations, a short description of the implementation, examples and experimental results. Reproducibility note: the examples in this paper can be run using the version of [commit 3dab492](https://github.com/constructum/asm-symbolic-execution/commit/3dab4927939e86a6c57c27308be7bde557d185b1) (release [v0.2](https://github.com/constructum/asm-symbolic-execution/releases/tag/v0.2)).
