...
rule Main = [
    ...
    seq
        par
            if a(0) > a(6) then { a(0) := a(6), a(6) := a(0) } endif
        ...
        par
            ...
            if a(3) > a(6) then { a(3) := a(6), a(6) := a(3) } endif
        endpar
        par
        ...
        par
            ...
            if a(4) > a(6) then { a(4) := a(6), a(6) := a(4) } endif
        endpar
        par
            if a(2) > a(3) then { a(2) := a(3), a(3) := a(2) } endif
            if a(4) > a(5) then { a(4) := a(5), a(5) := a(4) } endif
        ...
        par
            if a(1) > a(2) then { a(1) := a(2), a(2) := a(1) } endif
            if a(3) > a(4) then { a(3) := a(4), a(4) := a(3) } endif
            if a(5) > a(6) then { a(5) := a(6), a(6) := a(5) } endif
        endpar
    endseq;

    sorted := a(0) <= a(1) and a(1) <= a(2) and a(2) <= a(3) and a(3) <= a(4) and a(4) <= a(5) and a(5) <= a(6)
